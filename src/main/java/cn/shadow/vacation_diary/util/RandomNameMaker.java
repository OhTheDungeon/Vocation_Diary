...
public class RandomNameMaker {
	...
	public static String getFullName(Odds odds) {
		return getSurnameSet(1, odds).get(0) + getNameSet(1, odds).get(0);
	}

    public static List<String> getFullNameList(int count, Odds odds) {
        final List<String> fullNameList = new ArrayList<String>();
        final List<String> surnameList = getSurnameSet(count, odds);
        final List<String> nameList = getNameSet(count, odds);
     ...
     * @return 姓氏集合
     */
    private static List<String> getSurnameSet(int count, Odds r) {
        List<String> surnameList = new ArrayList<>(count);
        ...
        while (size < total) {
            newSurname = surname[r.getRandomInt(len)];
     ...
     * @return 名字集合
     */
    private static List<String> getNameSet(int count, Odds r) {
        ...
        while (size < total) {
            newName = r.getRandomInt(2) > 0 ? name[r.getRandomInt(len)] : name[r
                    .getRandomInt(len)] + name[r.getRandomInt(len)];
