...
public abstract class SurfaceProvider extends Provider {
	...
	final static double starfishOdds = Odds.oddsSomewhatLikely;
	...
	protected abstract void generateSurfacePoint(VocationCityWorldGenerator generator, PlatLot lot, RealBlocks chunk,
			CoverProvider foliage, int x, double perciseY, int z, boolean includeTrees);

	public void generateSurface(VocationCityWorldGenerator generator, PlatLot lot, RealBlocks chunk,
	...
	public void generateSurface(VocationCityWorldGenerator generator, PlatLot lot, RealBlocks chunk, int x, int y, int z,
	...
	public static SurfaceProvider loadProvider(VocationCityWorldGenerator generator, Odds odds) {
