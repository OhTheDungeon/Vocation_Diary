...
public final class Odds {
	...
	public Vec3d getRandomVelocity() {
		return getRandomVelocity(1.0);
	}

	private Vec3d getRandomVelocity(double delta) {
		return new Vec3d((random.nextDouble() * delta * 2) - delta, 0, (random.nextDouble() * delta * 2) - delta);
	}
	...
	public Block getRandomMaterial(Block... items) {
