...
import static cn.shadow.vacation_diary.dimension.support.CornerBlocks.UnitType.*;
...
//
	...
	public void drawNWVerticals(int i, AbstractBlocks blocks, int xInset, int y1, int y2, int zInset, Block primary,
			Block secondary, boolean outsetEffect, boolean onRoof) {
		getCorner(i).drawNWVerticals(blocks, xInset, y1, y2, zInset, primary, secondary, outsetEffect, onRoof);
	}

	public void drawNEVerticals(int i, AbstractBlocks blocks, int xInset, int y1, int y2, int zInset, Block primary,
			Block secondary, boolean outsetEffect, boolean onRoof) {
		getCorner(i).drawNEVerticals(blocks, xInset, y1, y2, zInset, primary, secondary, outsetEffect, onRoof);
	}

	public void drawSWVerticals(int i, AbstractBlocks blocks, int xInset, int y1, int y2, int zInset, Block primary,
			Block secondary, boolean outsetEffect, boolean onRoof) {
		getCorner(i).drawSWVerticals(blocks, xInset, y1, y2, zInset, primary, secondary, outsetEffect, onRoof);
	}

	public void drawSEVerticals(int i, AbstractBlocks blocks, int xInset, int y1, int y2, int zInset, Block primary,
			Block secondary, boolean outsetEffect, boolean onRoof) {
	...
	public void drawNWHorizontals(int i, AbstractBlocks blocks, int xInset, int y1, int y2, int zInset,
			Block primary, Block secondary, boolean outsetEffect, boolean onRoof) {
	...
	private class RoundedCorner extends Corner {
		...
		@Override
		public void drawNWVerticals(AbstractBlocks blocks, int xInset, int y1, int y2, int zInset, Block primary,
				Block secondary, boolean outsetEffect, boolean onRoof) {
		}

		@Override
		public void drawNEVerticals(AbstractBlocks blocks, int xInset, int y1, int y2, int zInset, Block primary,
				Block secondary, boolean outsetEffect, boolean onRoof) {
		}

		@Override
		public void drawSWVerticals(AbstractBlocks blocks, int xInset, int y1, int y2, int zInset, Block primary,
				Block secondary, boolean outsetEffect, boolean onRoof) {
		}

		@Override
		public void drawSEVerticals(AbstractBlocks blocks, int xInset, int y1, int y2, int zInset, Block primary,
				Block secondary, boolean outsetEffect, boolean onRoof) {
		}

		@Override
		public void drawNWHorizontals(AbstractBlocks blocks, int xInset, int y1, int y2, int zInset, Block primary,
				Block secondary, boolean outsetEffect, boolean onRoof) {
		}

		@Override
		public void drawNEHorizontals(AbstractBlocks blocks, int xInset, int y1, int y2, int zInset, Block primary,
				Block secondary, boolean outsetEffect, boolean onRoof) {
		}

		@Override
		public void drawSWHorizontals(AbstractBlocks blocks, int xInset, int y1, int y2, int zInset, Block primary,
				Block secondary, boolean outsetEffect, boolean onRoof) {
		}

		@Override
		public void drawSEHorizontals(AbstractBlocks blocks, int xInset, int y1, int y2, int zInset, Block primary,
				Block secondary, boolean outsetEffect, boolean onRoof) {
		}
	}
	...
	protected class CustomCorner extends Corner {
		...
		private void setVerticals(UnitType[][] source, AbstractBlocks blocks, int xInset, int y1, int y2, int zInset,
				Block primary, Block secondary, boolean outsetEffect, boolean onRoof, BlockFace connectedTo) {
			for (int x = 0; x < CornerBlocks.CornerWidth; x++) {
				for (int z = 0; z < CornerBlocks.CornerWidth; z++) {
					switch (source[x][z]) {
					case WWW:
...
//						break;
					...
					case BDD:
						if (!onRoof) {
							...
							blocks.setDoor(xInset + x, y1, zInset + z, Blocks.SPRUCE_DOOR,
					...
					case BRN:
						if (onRoof) {
							...
							blocks.setBlock(xInset + x, y1, zInset + z, Blocks.IRON_BARS,
									getDirections(source, x, z, connectedTo));
						}
						break;
					case BrN:
						if (onRoof) {
							...
							blocks.setBlock(xInset + x, y1, zInset + z, Blocks.SPRUCE_FENCE,
									getDirections(source, x, z, connectedTo));
						}
						break;
					case BgN:
						if (onRoof) {
							...
							blocks.setBlock(xInset + x, y1, zInset + z, Blocks.GLASS);
...
//									getDirections(source, x, z, connectedTo));
	...
	private Direction[] getDirections(UnitType[][] source, int x, int z, BlockFace connectedTo) {
